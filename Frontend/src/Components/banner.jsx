        ...
        <div className=" order-2 w-full md:w-1/2 mt-12 md:mt-32">
          <div className="space-y-12">
            <h1 className="text-4xl font-bold">
              Hello , Wellcomes here to learn somthing{" "}
              <span className="text-pink-600">new Everyday !!!</span>
            </h1>
            <p className="text-xl">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Itaque
              harum quasi provident nisi mollitia, laborum vero! Reprehenderit,
              quasi consequuntur magni ipsum amet, vero soluta, veniam autem
              illum optio quaerat debitis.
            </p>
